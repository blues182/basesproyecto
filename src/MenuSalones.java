...
public class MenuSalones {
    ...
    private static void agregarSalon() {
        String id = Utils.leerLinea("ID del salón (ej. IA104): ").trim();
        int capacidad = Utils.leerEntero("Capacidad: ");
        String tipo = Utils.leerLinea("Tipo (C = curso, SC = cómputo, A = auditorio): ")
                .trim().toUpperCase();
